 ...
 *
 *
 * OTP leaflet client config that let's it talk to the demo Bag geocoder of plannerstack
 * Replaces: OpenTripPlanner/src/client/js/otp/config.js
 * 
 */
...
otp.config = {
    ...
    siteName            : "Plannerstack OTP demo",
    siteDescription     : "A demo deployment of OpenTripplanner",
